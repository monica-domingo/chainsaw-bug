...
export function App() {
  return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700 text-white p-6">
          ...
          >
              Este proyecto usa un stack moderno para el desarrollo web con Preact. A continuación, exploramos sus principales tecnologías.
          </motion.p>
          ...
          >
              ...
              <Card>
                  ...
                  <CardContent>
                      Permite la creación de animaciones fluidas y atractivas con una API declarativa para Preact.
                  </CardContent>
              </Card>
              <Card>
                  <CardHeader>
                  ...
                  <CardContent>
                      Un entorno de desarrollo rápido y optimizado que mejora la experiencia de desarrollo en Preact y otras tecnologías modernas.
                  </CardContent>
              </Card>
          </motion.div>
